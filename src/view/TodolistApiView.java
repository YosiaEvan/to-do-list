...
public class TodolistApiView {
    ...
    public TodolistApiView(String host, Integer port, TodolistService todolistService) {
        this.host = host;
        this.port = port;
    ...
    private void sendResponse(HttpExchange exchange, ApiResponse apiResponse) throws IOException {
    ...
    private ApiResponse deleteTodoList(HttpExchange exchange) {
    ...
    private String getTodoListId(HttpExchange exchange) {
    ...
    private ApiResponse addTodoList(HttpExchange exchange) throws IOException {
        ApiResponse apiResponse = new ApiResponse();
    ...
    private <T> T getRequestBody(InputStream inputStream, Class<T> type) throws IOException {
